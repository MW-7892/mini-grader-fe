...
export default function DashboardHeader({ name }: { name: string }) {
  ...
  const [isDarkMode, setIsDarkMode] = useState<boolean>(
    (localStorage.getItem("minigrader-theme") ?? "light") === "dark",
  )
  ...
  const handleToggleDarkMode = () => {
    ...
    localStorage.setItem("minigrader-theme", isDarkMode ? "light" : "dark")
  }
  ...
  return (
    <>
      ...
      <TaskCreateDialog isOpen={isOpenCreateDialog} onClose={handleCloseCreateDialog} />
    </>
  )
}
