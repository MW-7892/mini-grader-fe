...
export type TaskQuery = { __typename?: 'Query', task?: { __typename?: 'Task', id: string, name: string, full_name: string, statement?: string | null, time_limit: number, memory_limit: number, is_public: boolean } | null };
